...
export class Backend implements backendInterface {
    ...
    async getConfig(): Promise<PresaleConfig> {
    ...
    async getPresaleEndTimestamp(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPresaleEndTimestamp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSoftCapSol(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getSoftCapSol();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTokenName(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getTokenName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setConfig(arg0: string, arg1: bigint, arg2: number, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setConfig(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
